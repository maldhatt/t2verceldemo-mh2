...
// import SaaStart components
import { OrganizationSwitcher } from "@/components/organization-switcher"; // Adjust path if needed
import { UserNav } from "@/components/user-nav"; // Adjust path if needed
...
export default function Header() {
  return (
     <div className=" px-8 -mt-4 border-b border-gray-500">
